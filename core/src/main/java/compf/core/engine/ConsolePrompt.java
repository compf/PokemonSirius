 ...
 * }
 * 
 * public int prompt(String prompt, IPrompt<Integer> promptHelper, int begin,
 * int[] args) {
 * System.out.println(prompt);
 ...
 * System.out.println(prompt);
 * }
 * public <T> int prompt(String prompt, IPrompt<T>
 * promptHelper,BiPredicate<Integer,T> test, T... args) {
 * System.out.println(prompt);
 * for (int i = 0; i < args.length; i++) {
 ...
 * return result;
 * }
 * public <T> int prompt(String prompt, IPrompt<T> promptHelper, ArrayList<T>
 * args) {
 * System.out.println(prompt);
