...
/*Power-Up Punch */
/*Has a 100% chance to raise the user's Attack by 1 stage. */
public class Power_Up_Punch extends PokemonBattleEffect{

public Power_Up_Punch(Pokemon pkmn){super(pkmn);}
