...
/*Dig */
/*This attack charges on the first turn and executes on the second. On the first turn, the user avoids all attacks other than Earthquake and Magnitude but takes double damage from them, and is also unaffected by weather. If the user is holding a Power Herb, the move completes in 1 turn. */
public class Dig extends PokemonBattleEffect{

public Dig(Pokemon pkmn){super(pkmn);}
