...
/*Geomancy */
/*Raises the user's Special Attack, Special Defense, and Speed by 2 stages. This attack charges on the first turn and executes on the second. If the user is holding a Power Herb, the move completes in 1 turn. */
public class Geomancy extends PokemonBattleEffect{

public Geomancy(Pokemon pkmn){super(pkmn);}
