...
/*Freeze Shock */
/*Has a 30% chance to paralyze the target. This attack charges on the first turn and executes on the second. If the user is holding a Power Herb, the move completes in 1 turn. */
public class Freeze_Shock extends PokemonBattleEffect{

public Freeze_Shock(Pokemon pkmn){super(pkmn);}
