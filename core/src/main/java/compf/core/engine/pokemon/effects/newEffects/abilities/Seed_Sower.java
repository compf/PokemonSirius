...
/*Seed Sower */
/*if this Pokemon is hit by an attack, the effect of Grassy Terrain begins. */
public class Seed_Sower extends PokemonBattleEffect{

public Seed_Sower(Pokemon pkmn){super(pkmn);}
