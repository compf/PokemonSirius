...
/*Electric Surge */
/*On switch-in, this Pokemon summons Electric Terrain. */
public class Electric_Surge extends PokemonBattleEffect{

public Electric_Surge(Pokemon pkmn){super(pkmn);}
