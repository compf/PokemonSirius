...
/*Rock Head */
/*This Pokemon does not take recoil damage, except Struggle. Does not affect Life Orb damage or crash damage. */
public class Rock_Head extends PokemonBattleEffect{

public Rock_Head(Pokemon pkmn){super(pkmn);}
