...
/*Chipped Pot */
/*Evolves Sinistea-Antique into Polteageist-Antique, if used. */
public class Chipped_Pot extends PokemonBattleEffect{

public Chipped_Pot(Pokemon pkmn){super(pkmn);}
