...
/*Trick-or-Treat */
/*Causes the Ghost type to be added to the target, effectively making it have 2 or 3 types. Fails if the target is already a Ghost type. If Forest's Curse adds a type to the target, it replaces the type added by this move and vice versa. */
public class Trick_or_Treat extends PokemonBattleEffect{

public Trick_or_Treat(Pokemon pkmn){super(pkmn);}
