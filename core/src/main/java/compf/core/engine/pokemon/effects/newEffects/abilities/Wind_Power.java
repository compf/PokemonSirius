...
/*Wind Power */
/*This Pokemon gains the Charge effect, if it takes a hit from a wind move or, if Tailwind begins on this Pokemon's side. */
public class Wind_Power extends PokemonBattleEffect{

public Wind_Power(Pokemon pkmn){super(pkmn);}
