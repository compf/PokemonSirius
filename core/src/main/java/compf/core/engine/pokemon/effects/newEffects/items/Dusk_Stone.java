...
/*Dusk Stone */
/*Evolves Murkrow into Honchkrow, Misdreavus into Mismagius, Lampent into Chandelure, and Doublade into Aegislash, if used. */
public class Dusk_Stone extends PokemonBattleEffect{

public Dusk_Stone(Pokemon pkmn){super(pkmn);}
