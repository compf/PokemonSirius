...
/*Genesis Supernova */
/*If this move is successful, the terrain becomes Psychic Terrain. */
public class Genesis_Supernova extends PokemonBattleEffect{

public Genesis_Supernova(Pokemon pkmn){super(pkmn);}
