...
/*Disable */
/*For 4 turns, the target's last move used becomes disabled. Fails if 1 of the target's moves is already disabled, if the target has not made a move, if the target no longer knows the move, or if the move was a Max or G-Max Move. */
public class Disable extends PokemonBattleEffect{

public Disable(Pokemon pkmn){super(pkmn);}
