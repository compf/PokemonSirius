...
/*Conversion */
/*The user's type changes to match the original type of the move in its first move slot. Fails if the user cannot change its type, or if the type is 1 of the user's current types. */
public class Conversion extends PokemonBattleEffect{

public Conversion(Pokemon pkmn){super(pkmn);}
