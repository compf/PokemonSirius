...
/*Regenerator */
/*This Pokemon restores 1/3 of its maximum HP, rounded down,, if it switches out. */
public class Regenerator extends PokemonBattleEffect{

public Regenerator(Pokemon pkmn){super(pkmn);}
