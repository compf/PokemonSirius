...
/*Priority moves used by opposing Pokemon targeting this Pokemon or its allies are prevented from having an effect.*/
 public class Queenly_Majesty extends PokemonBattleEffect{
...
/*@Override
 void onFoeTryMove(Pokemon target, Pokemon source, move) {
      ...
      if ((source.isAlly(dazzlingHolder) || move.target === "all") && move.priority > 0.1) {
        ...
        this.add("cant", dazzlingHolder, "ability: Queenly Majesty", Move move, "[of] " + target);
        return false;
      }
    }*/
public Queenly_Majesty(Pokemon pkmn) {
        super(pkmn);
    }
}