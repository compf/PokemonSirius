...
/*Strawberry Sweet */
/*Evolves Milcery into Alcremie, if held and spun around. */
public class Strawberry_Sweet extends PokemonBattleEffect{

public Strawberry_Sweet(Pokemon pkmn){super(pkmn);}
