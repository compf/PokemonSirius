...
/*Galarica Cuff */
/*Evolves Galarian Slowpoke into Galarian Slowbro, if used. */
public class Galarica_Cuff extends PokemonBattleEffect{

public Galarica_Cuff(Pokemon pkmn){super(pkmn);}
