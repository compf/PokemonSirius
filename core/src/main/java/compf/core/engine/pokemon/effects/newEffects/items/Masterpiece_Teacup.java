...
/*Masterpiece Teacup */
/*Evolves Poltchageist-Artisan into Sinistcha-Masterpiece, if used. */
public class Masterpiece_Teacup extends PokemonBattleEffect{

public Masterpiece_Teacup(Pokemon pkmn){super(pkmn);}
