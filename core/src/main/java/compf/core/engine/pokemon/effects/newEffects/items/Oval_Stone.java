...
/*Oval Stone */
/*Evolves Happiny into Chansey, if held and leveled up during the day. */
public class Oval_Stone extends PokemonBattleEffect{

public Oval_Stone(Pokemon pkmn){super(pkmn);}
