...
/*Forest's Curse */
/*Causes the Grass type to be added to the target, effectively making it have 2 or 3 types. Fails if the target is already a Grass type. If Trick-or-Treat adds a type to the target, it replaces the type added by this move and vice versa. */
public class Forest_s_Curse extends PokemonBattleEffect{

public Forest_s_Curse(Pokemon pkmn){super(pkmn);}
