...
/*Ice Burn */
/*Has a 30% chance to burn the target. This attack charges on the first turn and executes on the second. If the user is holding a Power Herb, the move completes in 1 turn. */
public class Ice_Burn extends PokemonBattleEffect{

public Ice_Burn(Pokemon pkmn){super(pkmn);}
