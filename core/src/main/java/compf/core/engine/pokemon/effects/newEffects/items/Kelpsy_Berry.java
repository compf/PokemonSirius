...
/*Kelpsy Berry */
/*Cannot be eaten by the holder. No effect, if eaten with Bug Bite or Pluck. */
public class Kelpsy_Berry extends PokemonBattleEffect{

public Kelpsy_Berry(Pokemon pkmn){super(pkmn);}
