...
/*Sun Stone */
/*Evolves Gloom into Bellossom, Sunkern into Sunflora, Cottonee into Whimsicott, Petilil into Lilligant, and Helioptile into Heliolisk, if used. */
public class Sun_Stone extends PokemonBattleEffect{

public Sun_Stone(Pokemon pkmn){super(pkmn);}
