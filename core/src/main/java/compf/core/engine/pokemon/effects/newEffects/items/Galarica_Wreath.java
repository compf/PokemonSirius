...
/*Galarica Wreath */
/*Evolves Galarian Slowpoke into Galarian Slowking, if used. */
public class Galarica_Wreath extends PokemonBattleEffect{

public Galarica_Wreath(Pokemon pkmn){super(pkmn);}
