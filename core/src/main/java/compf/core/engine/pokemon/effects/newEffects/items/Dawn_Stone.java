...
/*Dawn Stone */
/*Evolves male Kirlia into Gallade and female Snorunt into Froslass, if used. */
public class Dawn_Stone extends PokemonBattleEffect{

public Dawn_Stone(Pokemon pkmn){super(pkmn);}
