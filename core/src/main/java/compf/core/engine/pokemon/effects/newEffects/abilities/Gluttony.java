...
/*Gluttony */
/*if this Pokemon is holding a Berry that usually activates with 1/4 or less of its maximum HP, it is eaten at 1/2 or less of its maximum HP instead. */
public class Gluttony extends PokemonBattleEffect{

public Gluttony(Pokemon pkmn){super(pkmn);}
