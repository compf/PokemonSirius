...
/*Meteor Beam */
/*This attack charges on the first turn and executes on the second. Raises the user's Special Attack by 1 stage on the first turn. If the user is holding a Power Herb, the move completes in 1 turn. */
public class Meteor_Beam extends PokemonBattleEffect{

public Meteor_Beam(Pokemon pkmn){super(pkmn);}
