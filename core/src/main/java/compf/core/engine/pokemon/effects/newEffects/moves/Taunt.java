...
/*Taunt */
/*Prevents the target from using non-damaging moves for its next 3 turns. Pokemon with the Oblivious Ability or protected by the Aroma Veil Ability are immune. */
public class Taunt extends PokemonBattleEffect{

public Taunt(Pokemon pkmn){super(pkmn);}
