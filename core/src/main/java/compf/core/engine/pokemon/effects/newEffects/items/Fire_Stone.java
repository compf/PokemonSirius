...
/*Fire Stone */
/*Evolves Vulpix into Ninetales, Growlithe into Arcanine, Eevee into Flareon, and Pansear into Simisear, if used. */
public class Fire_Stone extends PokemonBattleEffect{

public Fire_Stone(Pokemon pkmn){super(pkmn);}
