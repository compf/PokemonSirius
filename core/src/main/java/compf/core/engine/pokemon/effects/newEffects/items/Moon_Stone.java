...
/*Moon Stone */
/*Evolves Nidorina into Nidoqueen, Nidorino into Nidoking, Clefairy into Clefable, Jigglypuff into Wigglytuff, Skitty into Delcatty, and Munna into Musharna, if used. */
public class Moon_Stone extends PokemonBattleEffect{

public Moon_Stone(Pokemon pkmn){super(pkmn);}
