...
/*Razor Wind */
/*Has a higher chance for a critical hit. This attack charges on the first turn and executes on the second. If the user is holding a Power Herb, the move completes in 1 turn. */
public class Razor_Wind extends PokemonBattleEffect{

public Razor_Wind(Pokemon pkmn){super(pkmn);}
