...
/*Electromorphosis */
/*This Pokemon gains the Charge effect, if it takes a hit from an attack. */
public class Electromorphosis extends PokemonBattleEffect{

public Electromorphosis(Pokemon pkmn){super(pkmn);}
