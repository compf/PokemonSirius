...
/*Shift Gear */
/*Raises the user's Speed by 2 stages and its Attack by 1 stage. */
public class Shift_Gear extends PokemonBattleEffect{

public Shift_Gear(Pokemon pkmn){super(pkmn);}
