...
/*Skull Bash */
/*This attack charges on the first turn and executes on the second. Raises the user's Defense by 1 stage on the first turn. If the user is holding a Power Herb, the move completes in 1 turn. */
public class Skull_Bash extends PokemonBattleEffect{

public Skull_Bash(Pokemon pkmn){super(pkmn);}
