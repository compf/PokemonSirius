...
/*Torment */
/*Prevents the target from selecting the same move for use 2 turns in a row. This effect ends when the target is no longer active. */
public class Torment extends PokemonBattleEffect{

public Torment(Pokemon pkmn){super(pkmn);}
