...
/*Illusion */
/*if this Pokemon switches in, it appears as the last unfainted Pokemon in its party until it takes direct damage from another Pokemon's attack. This Pokemon's actual level and HP are displayed instead of those of the mimicked Pokemon. */
public class Illusion extends PokemonBattleEffect{

public Illusion(Pokemon pkmn){super(pkmn);}
